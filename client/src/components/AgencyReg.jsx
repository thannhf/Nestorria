                ...
                <div className='flex flex-col md:w-1/2 p-8 md:p-10'>
                    ...
                    <div className='flex gap-2 xl:gap-3'>
                        <div>
                            ...
                            <input onChange={(e) => setName(e.target.value)} value={name} id="name" type="text" placeholder='Type here...' className='regular-14 border bg-secondary/10 border-slate-900/10 rounded-lg w-full px-3 py-1.5 mt-1 outline-none' required />
                        </div>
                        <div>
                            <label htmlFor="contact" className='medium-14'>Contact </label>
                            <input onChange={(e) => setContact(e.target.value)} value={contact} id="contact" type="text" placeholder='Type here...' className='regular-14 border bg-secondary/10 border-slate-900/10 rounded-lg w-full px-3 py-1.5 mt-1 outline-none' required />
                        </div>
                    </div>
